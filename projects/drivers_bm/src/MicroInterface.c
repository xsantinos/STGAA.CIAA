...
inline void MicroInterface_Init ()
{
	...
	Chip_SCU_PinMux( 1, 3, MD_PUP, FUNC0); //D0
	Chip_SCU_PinMux( 4, 6, MD_PUP, FUNC0); //D1
	Chip_SCU_PinMux( 4, 5, MD_PUP, FUNC0); //D2
	Chip_SCU_PinMux( 4, 4, MD_PUP, FUNC0); //D3
	Chip_SCU_PinMux( 6, 1, MD_PUP, FUNC0); //D4
	Chip_SCU_PinMux( 6, 4, MD_PUP, FUNC0); //D5
	Chip_SCU_PinMux( 6, 5, MD_PUP, FUNC0); //D6
	Chip_SCU_PinMux( 6, 7, MD_PUP, FUNC4); //D7

	//Mapeo pines de control
	Chip_SCU_PinMux( 1, 4, MD_PUP, FUNC0); //DI
	Chip_SCU_PinMux( 4, 10, MD_PUP, FUNC4);  //R_W
	Chip_SCU_PinMux( 4, 9, MD_PUP, FUNC4);  //EN
	Chip_SCU_PinMux( 6, 8, MD_PUP, FUNC4);  //CS1
	Chip_SCU_PinMux( 6, 9, MD_PUP, FUNC0);  //CS2
	Chip_SCU_PinMux( 6, 10, MD_PUP, FUNC0); //RST - Activo por bajo, entonces lo dejo en alto.
